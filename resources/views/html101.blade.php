                        ...
                        <div class="row mt-3 justify-content-center align-items-center">
                            ...
                            <div class="col-auto">
                                <select class="form-select" id="favColor" style="width: 250px;"
                                    ...
                                    <option value="Pastel Pink" style="background-color: #FFB7B2;">Pastel Pink
                                        (ชมพูพาสเทล)</option>
                                    ...
                                    <option value="Steel Blue" style="background-color: #4682B4; color: white;">Steel
                                        Blue (ฟ้าน้ำทะเล)</option>
                                    ...
                                    <option value="Chocolate" style="background-color: #D2691E; color: white;">Chocolate
                                        (ช็อกโกแลต)</option>
